...
title: 博客模板功能介绍
date: 2020-07-11
description: "介绍博客模板的响应式布局、评论、访问统计、目录、标签、代码高亮和配置方式。"
tags: jekyll   
featured: true
---


在此之前我有写过一篇[如何使用我博客模板的文章](https://baixinpan.github.io/2016/10/jekyll_tutorials1/) 请先看这篇基础集成，这篇文章主要讲的是如何使用和修改我的博客主题，文章内容含以下几点：
...
博客迭代信息请看[ReleaseNode](https://baixinpan.github.io/2020/07/ReleaseNode/)

遇到解决不了的问题可以找 [技术支持](https://baixinpan.github.io/support/)
