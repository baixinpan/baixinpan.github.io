...
再点击网址 `http://0.0.0.0:4000` OK终于可以看到属于你自己的blog啦，?，虽然很简陋，但好歹有了一个属于自己的小窝了。[参考链接](https://disqus.com/home/discussion/bsspirit/hexogithubweb/)，本地已经简单的设置好了，但是现在域名和服务器都是基于自己的电脑，接下来需要跟github进行关联。
...
翻到最下面，改成我这样子的，注意： `: 后面要有空格`
	...
	deploy:
	  type: git
	  repository: https://leopardpan.github.io/
	  branch: master
...
　然后再浏览器中输入[leopardpan.github.io](https://leopardpan.github.io/)就行了，我的 github 的账户叫 leopardpan ,把这个改成你 github 的账户名就行了
...
转载请注明原地址，潘柏信的博客：[leopardpan.github.io](https://leopardpan.github.io/) 谢谢！
